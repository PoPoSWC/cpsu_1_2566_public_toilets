...
class _HomePageState extends State<HomePage> {
  ...
  final _toiletPoinController = TextEditingController();
  final _toiletDisController = TextEditingController();
  @override
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: TextField(
                       controller: _toiletPoinController,
                        decoration: InputDecoration(
                          hintText: 'ให้คะแนน',
                          border: OutlineInputBorder(
                            borderSide: BorderSide(
                    ...
                    Expanded(
                      child: TextField(
                        controller: _toiletDisController,
                        decoration: InputDecoration(
                          hintText: 'ระยะทาง',
                          border: OutlineInputBorder(
                            borderSide: BorderSide(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      var toiletPion =_toiletPoinController.text;
                      var toiletDis = _toiletDisController.text;
                      var Dis = double.parse(toiletDis);
                      var pion=double.parse(toiletPion);
                      var toilet = Toilet(
                        name: toiletName,
                        point: pion,
                        distance: Dis,
